package com.sampleservice.ofoservice.controller;

import com.sampleservice.ofoservice.utils.MBaseUtils;
...
public class MainController extends MObject {
    ...
    public MResponse shareBikeFunction(@RequestBody MResponse requestData) {
        ...
        if (requestData.get("interval") != null) {
            MBaseUtils.generateStringInKBSize(1500, result, (long) requestData.get("interval"));
        }
        return result;
    }
}
